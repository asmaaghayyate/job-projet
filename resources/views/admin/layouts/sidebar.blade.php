...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="#">
            ...
            <img src="{{ asset('assets/images/logo.png') }}" alt="Work Scout" />
            

            </a>
        <a class="desktop-logo logo-dark active" href="#">
            <img
                src="{{ asset('assets2/img/brand/logo-white.png') }} " class="main-logo dark-theme" alt="logo">
        ...
        <a class="logo-icon mobile-logo icon-dark active" href="#">
            <img
                src="{{ asset('assets2/img/brand/favicon-white.png') }}" class="logo-icon dark-theme" alt="logo">
            </a>
    </div>
