...
================================================== -->
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css"
        integrity="sha384-k6RqeWeci5ZR/Lv4MR0sA0FfDOMjB4cH1/4r15W9n2m30v3Re/Tq7w4v3H0Z4H20" crossorigin="anonymous">
...
<style>
    .icon-color {
        color: #53b427;
        /* Change ici pour la couleur souhaitée */
        font-size: 24px;
...
<style>
    .manage-table td {
        ...
        padding: 5px 10px;
        /* Ajouter du padding pour espacer le texte */
        margin: 0;
        /* Pas de marge externe pour les cellules */
        font-size: 0.85em;
 ...
 --}}
                            ...
                            @if (Auth::check())
                                <li><a href=""><i class="fa fa-user"></i> {{ auth()->user()->name }}</a>
                                    <ul class="">
                                        <li><a href="{{ route('monprofile') }}"><i class="fa fa-user"></i>Profile</a>
                                        </li>
            ...
            <div class="container">
                ...
                <div class="seven columns">
                    ...
                    <p>WorkScout est le premier site d’emploi mondial1 enregistrant
                        ...
                        permettant de chercher un emploi, de publier leur CV et de se renseigner au sujet des
                        entreprises,
                        le tout gratuitement. Chaque jour, nous offrons de nouvelles
                        opportunités à des millions de personnes..</p>
                    <a href="{{ route('publierannance') }}" id="current" class="button">Publier une offre
                        d'emploi</a>
                </div>
            ...
            <div class="container">
                <div class="footer-bottom">
                    <div class="sixteen columns">
                        ...
                        <div class="copyrights">© Copyright 2024 par <a href="#">Work Scout</a>. Tous droits
                            réservés.</div>
