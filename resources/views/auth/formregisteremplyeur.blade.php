		...
		<div class="tabs-container">
			...
			<!-- Login -->
				...
				<div class="tab-content" id="tab2" style="display: none;">
					...
					@endif
					<h3 class="margin-bottom-10 margin-top-10">S'inscrire</h3>

					<form class="register" action="{{route('registeremplyeur')}}" method="post" >				
					@csrf

					<input type="hidden" name="role" id="role" value="employeur"> 	
						...
						<p class="form-row">
							<input type="submit" class="button" name="register" value="s'inscrire" />
						</p>
